...
public class BombermanKeyAdapter extends KeyAdapter {
    ...
    public BombermanKeyAdapter(Player game) {
        this.myPlayer = game;
        movePlayerControl = ControlFactory.instance().createClient2ServerControl(MovePlayerControl.class);
        dropBombControl = ControlFactory.instance().createClient2ServerControl(DropBombControl.class);
    }
