...
public class Dispatcher implements ClientApplicationInterface {
    private final Map<Class<? extends Message>, Class<? extends Server2ClientControl>> controlMap;
    ...
    public void handleMessage(Message message) {
        ...
        if (controlMap.containsKey(messageType)) {
            Class<? extends Server2ClientControl> controlClass = controlMap.get(messageType);
            Server2ClientControl control = ControlFactory.instance().createServer2ClientControl(controlClass);
